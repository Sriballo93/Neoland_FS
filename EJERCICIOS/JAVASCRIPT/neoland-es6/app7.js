...
const scoretotal = exams.reduce((accumulator, exam) => {
...
const aprobadosTotal = exams.filter(exam => exam.score >= 5)
	.reduce((acc, exam) => acc + exam.score, 0);
    console.log(aprobadosTotal)

// 7.3 Dado el mismo array, haz la media de las notas de todos los examenes .reduce().

let media = scoretotal/ exams.length;
    console.log(media);