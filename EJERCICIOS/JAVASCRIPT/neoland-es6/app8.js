...
const filtervideogame= videogames.filter(videogame => videogame.genders.includes('RPG') === true )

console.log(filtervideogame) 
const scoretotal = filtervideogame.reduce((accumulator, videogame) => {
return accumulator + videogame.score}, 0);
console.log(scoretotal);

let media = scoretotal/ filtervideogame.length;
console.log(media);
